  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
      <div className="flex items-center justify-between gap-4 mb-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white whitespace-nowrap">📋 Meeting Details</h3>
        <select
          value={formData.business_id}
          onChange={(e) => {
            const newBusinessId = e.target.value;
            setFormData({ ...formData, business_id: newBusinessId });
            handleBlur('business_id', newBusinessId);
          }}
        ...
        <button
          ...
          className="text-gray-500 hover:text-gray-700 transition-transform flex-shrink-0"
